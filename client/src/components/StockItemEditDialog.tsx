              ...
              <Collapsible open={advancedOpen} onOpenChange={setAdvancedOpen}>
                <div className="rounded-lg border">
                  <CollapsibleTrigger asChild>
                    ...
                    >
                      <span>
                        <span className="block text-sm font-medium">Advanced product details</span>
                        <span className="block text-xs font-normal text-muted-foreground">
                          Barcode, stock group, variants, and active status.
                        </span>
                      </span>
                      <ChevronDown
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="border rounded-lg overflow-hidden">
                          ...
                          {showAddVariant && (
                            <div className="px-4 py-3 space-y-3 bg-muted/10">
                              ...
                              <p className="text-xs text-muted-foreground">
                                Inherits UOM (<strong>{uom || stockItem?.uom}</strong>) and stock
                                group from this item.
                              </p>
                      ...
                      <div className="flex items-center justify-between rounded-md border px-3 py-3">
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">
                            Inactive products remain in history but are unavailable for normal use.
                          </p>
                        </div>
                        <Switch
                          id="active"
