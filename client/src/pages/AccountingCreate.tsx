...
function EntityFormWrapper({ 
  ...
  const createMutation = useMutation({
    ...
    onSuccess: (data: any) => {
      ...
      // Explicitly reset to default values and clear any form state
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Name *</FormLabel>
                  <FormControl>
                    <Input {...field} placeholder="Honda Motorcycles" data-testid="input-name" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
                ...
                <FormItem className="flex items-center gap-2 space-y-0 pt-8">
                  <FormControl>
                    <Checkbox
                      checked={field.value}
                      onCheckedChange={field.onChange}
                      data-testid="checkbox-allocate-import-costs"
                    />
                  </FormControl>
                  <FormLabel className="!mt-0">Allocate Import Costs (Motos)</FormLabel>
                  <FormDescription className="!mt-0 ml-2">
                    Enable for moto groups - import costs will only be allocated to items in this group
                  </FormDescription>
                </FormItem>
              )}
            />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Name *</FormLabel>
                  <FormControl>
                    <Input {...field} placeholder="Honda CG 125" data-testid="input-name" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input {...field} placeholder="Unit, Pcs" data-testid="input-uom" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
